...
namespace Io.Gitlab.Buziproject.V1.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.202209251248.0";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("thunes-mt/0.202209251248.0/csharp");
        ...
        public Configuration(
            ...
            string baseUrl = "https://petstore3.swagger.io") : this()
        {
            if (string.IsNullOrWhiteSpace(baseUrl))
                throw new ArgumentException("The provided baseUrl is invalid.", "baseUrl");
        ...
        {
            string report = "C# SDK (Io.Gitlab.Buziproject.V1) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.0.0\n";
            report += "    SDK Package Version: 0.202209251248.0\n";
        ...
        public static IReadableConfiguration MergeConfigurations(IReadableConfiguration first, IReadableConfiguration second)
        {
            ...
            var config = new Configuration
            {
                ...
                BaseUrl = second.BaseUrl ?? first.BaseUrl,
